            ...
            <div class="grid-container">
                    ...
                    <div class="large-8 medium-9 small-12 cell centered">
                        <div class="brew-method option" v-on:click="toggleSelectedBrewMethod( method.id )"
                            ...
                            <div class="option-container">
                                <img v-bind:src="method.icon+'.svg'" class="option-icon"/> <span
                ...
                <div class="grid-x grid-padding-x">
                    <div class="large-8 medium-9 small-12 cell centered">
                        <div class="drink-option option" v-on:click="matcha == 0 ? matcha = 1 : matcha = 0"
                            ...
                            <div class="option-container">
                                <img v-bind:src="'/img/icons/matcha-latte.svg'" class="option-icon"/> <span
                                    class="option-name">Matcha</span>
                            </div>
                        </div>
                        <div class="drink-option option" v-on:click="tea == 0 ? tea = 1 : tea = 0"
                             v-bind:class="{'active': tea == 1 }">
                            <div class="option-container">
                                <img v-bind:src="'/img/icons/tea-bag.svg'" class="option-icon"/> <span
                                    class="option-name">Tea Options</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid-x grid-padding-x">
                    <div class="large-8 medium-9 small-12 cell centered">
                        ...
                        <input type="text" id="street-address" placeholder="Street Address" class="form-input"
...
//      },
        ...
        methods: {
            ...
            validateNewCafe(){
                ...
                /*
                 Ensure a company name has been entered
                 */
